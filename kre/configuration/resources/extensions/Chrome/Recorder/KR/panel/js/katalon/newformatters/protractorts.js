...
newFormatters.protractorts = function(name, commands) {
  ...
  const newprotractorts = function (scriptName){
    ...
    // katalon
    // https://docs.katalon.com/katalon-platform/plugins-and-add-ons/katalon-recorder-extension/get-your-job-done/automate-scenarios/selenese-selenium-ide-commands-reference
